...
A comprehensive collection of graduate-level lecture slides, code examples, datasets, and practical tutorials on survival analysis and modern risk modeling methods for medical research.
...
David Collett (2024). *Modelling Survival Data in Medical Research* (4th Edition). CRC Press.
